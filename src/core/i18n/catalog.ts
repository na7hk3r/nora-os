...
export const copy: Record<AppLanguage, AppCopy> = {
  es: {
    ...
    sidebar: {
      ...
      showPages: (name) => `Mostrar paginas de ${name}`,
      hidePages: (name) => `Ocultar paginas de ${name}`,
      dragToReorder: 'Arrastrar para reordenar',
      config: 'Config',
      logout: 'Cerrar sesion',
      shortcuts: 'Atajos',
      streak: (days) => `Racha de ${days} dias`,
      progressTitle: (level, points) => `Pulso Nora - Nori nivel ${level} - ${points} XP - Ver progreso completo`,
    },
    shell: {
      skipToContent: 'Saltar al contenido principal',
      goBack: 'Volver',
      goBackAria: 'Volver atras',
    },
    workspace: {
      unavailableTitle: 'Vista no disponible',
      unavailableDescription: (path) => `La ruta ${path} no esta registrada o pertenece a un modulo desactivado.`,
      leftPane: 'Izquierda',
      rightPane: 'Derecha',
    ...
    commandPalette: {
      ...
      emptyHint: 'Proba con una nota, tarea, enlace, seccion o #tag.',
      hintPrefix: 'Tip: podes buscar todo con',
      ...
      actions: {
        ...
        openDualSubtitle: 'Mostrar dos vistas en simultaneo',
        closeDual: 'Cerrar vista dual',
        closeDualSubtitle: 'Volver a una sola vista',
        activatePrimary: 'Activar panel izquierdo',
        activatePrimarySubtitle: 'La navegacion abre en la izquierda',
        activateSecondary: 'Activar panel derecho',
        activateSecondarySubtitle: 'La navegacion abre en la derecha',
      },
      tagConnections: (count) => `${count} conexion${count === 1 ? '' : 'es'} globales`,
    },
    dashboard: {
      recentActivity: 'Actividad reciente',
      fullHistory: 'Ver historial completo ->',
      viewModule: 'Ver modulo',
      expandModule: 'Expandir modulo',
      collapseModule: 'Colapsar modulo',
      restoreModule: 'Restaurar modulo',
      noActiveModulesTitle: 'Sin modulos activos',
      noActiveModulesBody: 'Activa al menos un plugin para ver contenido en el dashboard',
      goToSettings: 'Ir a Configuracion',
      pluginTip: 'Tip: activar un plugin agrega widgets, paginas y navegacion automaticamente.',
      progressMovedPrefix: 'Tu progreso global ahora vive en',
      progressMovedLink: 'Progreso',
      progressMovedSuffix: '. El Dashboard se enfoca en lo que tenes que hacer hoy.',
      closeNotice: 'Cerrar aviso',
      restoreSize: (title) => `Restaurar tamano de ${title}`,
    ...
    auth: {
      ...
      recoveryQuestion: 'Pregunta de recuperacion (min 10 caracteres)',
      recoveryAnswer: 'Respuesta',
      recoveryAnswerPrivate: 'Respuesta (sera privada y sensible a mayusculas)',
      newPassword: 'Nueva contrasena (min 8 caracteres)',
      ...
      passwordUpdated: 'Contrasena actualizada. Inicia sesion con tu nueva contrasena.',
    ...
    control: {
      ...
      description: 'Administra identidad, preferencias, modulos y salud general de la plataforma desde un unico panel.',
      monitoring: 'Monitoreo operativo activo en tiempo real',
      nav: {
        profile: 'Cuenta',
        preferences: 'Apariencia',
        pluginManager: 'Modulos',
      ...
      unsavedSections: (count) => `${count} seccion${count === 1 ? '' : 'es'} sin guardar`,
      kpis: {
      ...
      appearance: {
        title: 'Apariencia',
        description: 'Tema visual, idioma y comportamiento de navegacion.',
        ...
        sidebarCollapsedHelp: 'Tambien podes alternarlo desde el boton lateral.',
        themeTitle: 'Tema',
        themeGallery: (count) => `Ver los ${count} temas con previsualizacion en vivo ->`,
      ...
      plugins: {
        ...
        saving: 'Guardando...',
        saveModules: 'Guardar modulos',
        howAddTitle: 'Como agregar nuevos plugins?',
        howAddBody: 'En esta version, los plugins se incluyen en el build y se activan/desactivan sin friccion desde aqui.',
        saved: 'Modulos guardados correctamente.',
        failedSave: 'No se pudieron guardar los modulos.',
        failedActivate: (names) => `No se pudieron activar: ${names}.`,
      },
      leaveGuard: {
        title: 'Hay cambios sin guardar',
        body: 'Estas secciones tienen cambios locales. Nada se aplico todavia.',
        stay: 'Quedarme',
